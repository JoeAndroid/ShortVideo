package com.joe.shortvideo.helper;
...
public class FilterTypeHelper {
    ...
    public static int FilterType2Thumb(MagicFilterType filterType) {
        switch (filterType) {
            ...
            case NONE:
                return R.mipmap.original;
            case WHITECAT:
                return R.mipmap.whitecat;
            case BLACKCAT:
                return R.mipmap.blackcat;
            case ROMANCE:
                return R.mipmap.romance;
            case SAKURA:
                return R.mipmap.sakura;
            case AMARO:
            ...
            case ANTIQUE:
                return R.mipmap.antique;
            case SKINWHITEN:
                return R.mipmap.skinwhiten;
            case CALM:
                return R.mipmap.calm;
            case COOL:
                return R.mipmap.cool;
            case EMERALD:
                return R.mipmap.emerald;
            case EVERGREEN:
                return R.mipmap.evergreen;
            case FAIRYTALE:
                return R.mipmap.fairytale;
            case HEALTHY:
                return R.mipmap.healthy;
            case NOSTALGIA:
                return R.mipmap.nostalgia;
            case TENDER:
                return R.mipmap.tender;
            case SWEETS:
                return R.mipmap.sweets;
            case LATTE:
                return R.mipmap.latte;
            case WARM:
                return R.mipmap.warm;
            case SUNRISE:
                return R.mipmap.sunrise;
            case SUNSET:
                return R.mipmap.sunset;
            case CRAYON:
                return R.mipmap.crayon;
            case SKETCH:
                return R.mipmap.sketch;
            default:
                return R.mipmap.original;
        }
    }
