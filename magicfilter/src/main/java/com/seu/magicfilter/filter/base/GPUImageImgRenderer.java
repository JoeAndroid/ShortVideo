...
import static com.seu.magicfilter.utils.TextureRotationUtil.TEXTURE_NO_ROTATION;

@TargetApi(11)
public class GPUImageImgRenderer implements Renderer, PreviewCallback {
    ...
    public GPUImageImgRenderer(final GPUImageFilter filter) {
        mFilter = filter;
        ...
        runOnDraw(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    camera.setPreviewCallback(GPUImageImgRenderer.this);
                    camera.startPreview();
                } catch (IOException e) {
                    e.printStackTrace();
                }
